...
import threading
from src.watchdog.utils import BaseThread
from src.watchdog.utils.compat import queue
from src.watchdog.utils.bricks import SkipRepeatsQueue
try:
...
class EventEmitter(BaseThread):
    ...
    :type event_queue:
        :class:`src.watchdog.events.EventQueue`
    :param watch:
...
class BaseObserver(EventDispatcher):
    ...
    def schedule(self, event_handler, path, recursive=False):
        ...
        :param event_handler:
            ...
            file system events.
        :type event_handler:
            :class:`src.watchdog.events.FileSystemEventHandler` or a subclass
        :param path:
