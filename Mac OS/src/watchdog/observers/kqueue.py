...
"""
:module: src.watchdog.observers.kqueue
...
from src.watchdog.utils import platform
...
from src.watchdog.observers.api import (
    BaseObserver,
    EventEmitter,
...
from src.watchdog.utils import stat as default_stat
from src.watchdog.utils.dirsnapshot import DirectorySnapshot

from src.watchdog.events import (
    DirMovedEvent,
    DirDeletedEvent,
    DirCreatedEvent,
    DirModifiedEvent,
...
class KqueueEmitter(EventEmitter):
    ...
    :type watch:
        :class:`src.watchdog.observers.api.ObservedWatch`
    :param timeout:
    ...
    def queue_event(self, event):
        ...
        :param event:
            An instance of :class:`src.watchdog.events.FileSystemEvent`
            or a subclass.
        """
